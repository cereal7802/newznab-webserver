...
RUN DEBIAN_FRONTEND=noninteractive apt-get -y install apache2 php libapache2-mod-php php-pear php-gd php-mysql php-mbstring php-curl php-json php-memcached unrar lame mediainfo subversion ffmpeg supervisor wget
